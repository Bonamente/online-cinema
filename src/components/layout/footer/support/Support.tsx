...
const Support = () => {
  ...
  return (
    <div className={`flex flex-col ${isSmallScreen ? 'py-6' : 'w-1/4 px-3'}`}>
      {isSmallScreen ? (
        <DropdownBtn isDropdownOpen={isDropdownOpen} handleClick={handleDropdownClick}>
      ...
      {(isDropdownOpen && isSmallScreen) || !isSmallScreen ? (
        <div className={`${isSmallScreen ? 'mt-6' : ''}`}>
          ...
          <div className={isSmallScreen && !isMobile ? 'flex items-center w-1/2' : ''}>
            <div className={`${isSmallScreen ? '' : 'w-3/4'} mt-3`}>
            ...
            <div
              className={`flex relative ${isSmallScreen ? 'mt-3' : 'mt-5'} ${
